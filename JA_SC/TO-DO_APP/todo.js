...
function CreateToDoItems() {
    if (todoValue.value === "") {
        ...
        <img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="pencil.jpg"/>
        <img class="delete todo-controls" onclick="DeleteToDoItems(this)" src="delete.jpg"/></div></div>`;
...
function ReadToDoItems() {
    todo.forEach((element) =>{
        ...
        ${
            style === ""
            ? ""
            : '<img class="todo-controls" src="check-mark.jpg"/>'
        }</div><div>
        ${
            style === ""
            ? '<img class="edit todo-controls" onclick="UpdateToDoItems(this)" src="pencil.jpg" />'
        ...
        <img class="delete todo-controls" onclick="DeleteToDoItmes(this)" src="delete.jpg" /></div><div>`;
        li.innerHTML = todoItems;
        listItems.appendChild(li);
...
function UpdateToDoItems(e) {
    if(e.parentElement.parentElement.querySelector("div").style.textDecoration === "") {
        ...
        addUpdate.setAttribute("src", "refrsh.jpg");
        todoValue.focus();
    }
}
...
function UpdateOnSelectionItems() {
    ...
    if (IsPresent) {
        setAlertMessage("This item already in the list!");
        return;
    }
    ...
    addUpdate.setAttribute("src", "plus.jpg");
    todoValue.value = "";
